import { ToscaWorkflowActivityCallOperation } from '#src/model/workflow/workflow_activity_call_operation.js';
  ...
  exit_workflow_activity_call_operation(parsed_rule) {
    if (typeof parsed_rule.value === 'string') {
      validateCreateAndRegister(
        ToscaWorkflowActivityCallOperation,
        { operation: parsed_rule.value },
        parsed_rule,
      );
    } else {
