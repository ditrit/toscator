...
// abstract node
const abs_st = parse('./tests/data_manual/test_substitution/test_capability_filter_passFilter/abstractNode.yml');
...
// concrete node
const concrete_st = parse('./tests/data_manual/test_substitution/test_capability_filter_passFilter/concreteNode.yml');
