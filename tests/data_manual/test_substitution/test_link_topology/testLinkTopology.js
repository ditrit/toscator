...
import { addTopology, linkTopology, selectSubstituteServiceTemplate } from '#src/substitution/mapping_substitution.js';

const parser = new Parser(new NodeJsFileManager());

// abstract node
const abs_st = parser.parse('./tests/data_manual/test_substitution/test_link_topology/abstractNode.yml');
const abs1 = abs_st.topology_template.node_templates.get('abs1');

// concrete node
const concrete_st = parser.parse('./tests/data_manual/test_substitution/test_link_topology/concreteNode.yml');
